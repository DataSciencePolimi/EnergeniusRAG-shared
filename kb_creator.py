...
ke.run(
    ...
    html_links=[
        ...
        #"https://build-up.ec.europa.eu/en/resources-and-tools/publications/improving-energy-efficiency-housing-smarter-housing-investments",
        #"https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32023L1791",
    ],
    pdf_links=[
        #"https://build-up.ec.europa.eu/system/files/2025-09/Zw41E6Ohjw_24_09_2025_094336.pdf",
    ],
)
